...
const UserNavigation = ({ onSwitchToAdmin }) => {
  ...
  const handleSmoothScroll = (e, targetId) => {
    ...
    navigate(`/user#${targetId}`, { replace: true });
  };
    ...
    <nav className="sticky top-0 z-50 bg-white shadow-md">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center gap-6">
          <Link to="/user" className="text-2xl font-bold text-gray-800 hover:text-blue-600 transition-colors">
            Portfolio
          </Link>
          
          <div className="hidden md:flex items-center gap-6 ml-8">
            <Link to="/user" className="text-gray-700 hover:text-blue-600 transition-colors">Home</Link>
            <Link to="/user/blog" className="text-gray-700 hover:text-blue-600 transition-colors">Blog</Link>
            <a href="#about" onClick={(e) => handleSmoothScroll(e, 'about')} className="text-gray-700 hover:text-blue-600 transition-colors">About</a>
            <a href="#projects" onClick={(e) => handleSmoothScroll(e, 'projects')} className="text-gray-700 hover:text-blue-600 transition-colors">Projects</a>
